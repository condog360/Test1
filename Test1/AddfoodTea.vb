Public Class AddfoodTea
    Private Sub AddfoodTea_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        FoodName = txt_FoodName.Text
        MainMenuScreen.ListBox3.Items.Add(txt_FoodName.Text)
