Public Class AddFoodSnacks
    Private Sub AddFoodSnacks_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        FoodName = txt_FoodName.Text
        MainMenuScreen.ListBox4.Items.Add(txt_FoodName.Text)
